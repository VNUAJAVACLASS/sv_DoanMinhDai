...
public class BookServlet extends HttpServlet {
	...
	public void init() {
		// Dữ liệu giả
		booksList.add(new Book(idCounter++, "Tiêu đề 1", "Author 1", 100000L, ""));
		booksList.add(new Book(idCounter++, "Tiêu đề 2", "Author 2", 100000L, ""));
		booksList.add(new Book(idCounter++, "Tiêu đề 3", "Author 3", 100000L, ""));
	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "delete":
			...
			resp.sendRedirect("books"); // quay lại trang chủ tin tức
			break;
		case "detail":
